...
CREATE TABLE `Answers` (
  ...
  CONSTRAINT `answers_ibfk_3` FOREIGN KEY (`option_id`) REFERENCES `Options` (`id`) ON DELETE SET NULL
...
INSERT INTO `Answers` VALUES (1,1,28,'Very Satisfied',1,'2025-01-03 03:28:23');
